...
class ManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufacturer" do
    assert_difference("Manufacturer.count") do
      post manufacturers_url, params: { manufacturer: { description: @manufacturer.description, name: @manufacturer.name, origin_location: @manufacturer.origin_location } }
    end
  ...
  test "should update manufacturer" do
    patch manufacturer_url(@manufacturer), params: { manufacturer: { description: @manufacturer.description, name: @manufacturer.name, origin_location: @manufacturer.origin_location } }
